  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between py-4">
          <div className="flex items-center gap-2">
            <Image src="/placeholder.svg?height=32&width=32" width={32} height={32} alt="ロゴ" />
            <span className="text-xl font-bold">Eラーニング</span>
          </div>
      ...
      <main className="flex-1">
        ...
        <div id="courses" className="bg-muted/40">
          <CourseShowcase />
        </div>
      ...
      <footer className="border-t bg-muted/40">
        <div className="container py-12 md:py-16 lg:py-20 max-w-[1280px] mx-auto">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                いつでもどこでも、自分のペースで学べる新しい学習体験を提供します。
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
            <p>© 2023 Eラーニング プラットフォーム. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
